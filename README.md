...
| 073 | [Adapter registry and detached durability](docs/en/rfc/073-rfc-adapter-registry-detached-durability.md) | Deliver RFC 067 as adapter, durable-supervisor, live-provider, and routing slices | slices 1–2 implemented | v3.61.0 · 2026-07-16 | provider-keyed `launch_argv/stop/resume/health` registry (Codex/Claude migrated byte-identical; Gemini validated stub) + detached durable control plane (`fleet supervise --detach`, crash-consistent store, PID start-identity reconciliation); slices 3–4 accepted |
