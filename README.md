...
| 037 | [Agent context compression backends](docs/en/rfc/037-rfc-agent-context-compression-backends.md) | Digest-based context compression + bounded raw references | Phase D shipped | v3.39.0 · 2026-07-01 | `m8shift-context.py compress/retrieve`, redaction-before-store, builtin + RTK shell/tool dispatch + optional `headroom_ext` broad-context dispatch, reference-only fail-safe |
