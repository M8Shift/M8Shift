...
| [064-rfc-effective-time-accounting.md](rfc/064-rfc-effective-time-accounting.md) | Draft effective-work/non-work accounting: exact append-only state durations going forward, honest unclassified legacy spans, per-agent/work-item breakdowns, and one global dashboard TIME strip. |
