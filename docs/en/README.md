...
| [077-rfc-safe-boundary-model-line-routing.md](rfc/077-rfc-safe-boundary-model-line-routing.md) | Accepted same-provider safe-boundary routing design; Slices A-C implement fixture evidence, disabled vendor adapters, and pure dry-run policy/audit while listener routing remains disabled. |
