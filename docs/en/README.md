...
| [049-rfc-holder-liveness-stale-claim-hardening.md](rfc/049-rfc-holder-liveness-stale-claim-hardening.md) | Draft holder-liveness RFC for #6: separates pen TTL from holder heartbeat, hardens force-claim, and adds worktree single-ownership. |
