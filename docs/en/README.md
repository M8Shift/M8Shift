...
| [036-rfc-token-window-exhaustion.md](rfc/036-rfc-token-window-exhaustion.md) | Proposed companion-level headroom guard for token-window exhaustion detection, checkpointing, and graceful pause. |
