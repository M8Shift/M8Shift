...
| [048-rfc-adoption-discipline-pack-update-health.md](rfc/048-rfc-adoption-discipline-pack-update-health.md) | Draft adoption-surface RFC for #18/#19/#20: generated `M8SHIFT.agent-guide.md` + anchors reference, local no-network `update`, and adoption-health `doctor` checks. |
