...
| [065-rfc-ticketed-committed-pushed-delivery.md](rfc/065-rfc-ticketed-committed-pushed-delivery.md) | Draft delivery discipline: one structured forge ticket and committed, pushed history for every intentional change, with a named gateway for network-isolated authors. |
