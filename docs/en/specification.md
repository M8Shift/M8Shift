...
rather than trusting process exit status. Invalid sidecar JSON/JSONL is reported as
a runtime diagnostic finding instead of a core parse failure. Deleting
